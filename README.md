# 모바일 청첩장 프로젝트
* 기존 repo를 fork 한 것이므로, 기존 repo 의 'README' 내용을 임시로 주석처리 함
* fork 사용방법이나, github page 활용 방법이 아직 익숙치 않으므로, 일정 수준 정리 된 이후 readme 등을 업데이트 예정입니다. 

# 000과 000의 결혼식 모바일 청첩장입니다
* 내용 보실 분들은 대충 아시겠지만, 완성작은 아니라 간단하게만 적어뒀습니다.
* 웹개발 경험이 전무해서 일단 내용만 적당히 바꿨습니다
* 방명록 기능 구현하고싶어요

<!-- # 손지훈과 최미지의 결혼식 모바일 청첩장
